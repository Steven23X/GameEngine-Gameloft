...
Terrain::Terrain(unsigned idSo, const Vector3& position, const Vector3& rotation, const Vector3& scale, Model* model,
                 ...
                 float offsetY, Vector3 heights, Vector3 cameraPosition,FogResource fog, AmbientalLightResource alr) : SceneObject(idSo, position, rotation, scale,
	                                                                           model,
	                                                                           shader, textures, depthTest, isWired,
	                                                                           isFollowingCamera, followingCamera,fog,alr),
                                                                           nrCells(nrCells),
                                                                           dimCells(dimCells),
                                                                           offsetY(offsetY),
